...
export default function TradeStreamMobile(params:any) {
  ...
  return (
      ...
      {/* charts */}
      <StarGraph centerNode={centerNode} satellites={satelliteNodes} GrapWidth={streamInfo?.wrapperWidth} GrapHeight={streamInfo?.wrapperHeight - 270}/>
      {/* performance */}
