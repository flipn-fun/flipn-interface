  ...
  return (
    ...
    >
      <div className={styles.InviterContainer}>
        ...
        <div
          className={clsx(
            !staticInviter && !inviterData?.account_icon
              ? styles.InviterAvatarWrapperEmpty
              : styles.InviterAvatarWrapper
          )}
        >
          {loadingInviterData ? (
            <Skeleton animated className={styles.InviterAvatarLoading} />
          ) : (
            <img
              src={
                staticInviter
                  ? staticInviter.logo
                  : inviterData?.account_icon || "/img/avatar.png"
              }
              alt=""
