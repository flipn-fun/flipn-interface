import { EventEmitter, isIosAndRedirectable, SendTransactionOptions, WalletName } from '@solana/wallet-adapter-base';
import {
  ...
  constructor(config: BackpackWalletAdapterConfig = {}) {
    ...
    if (this._readyState !== WalletReadyState.Unsupported) {
      if (isIosAndRedirectable()) {
        ...
        scopePollingDetectionStrategy(() => {
          if (window?.backpack?.solana?.isBackpack || window.solana?.isBackpack) {
