...
export const programId_address =
  process.env.NEXT_PUBLIC_PROGRAM_ID ||
  "67g5ZLhs2Nhobhm69u5vdxJutF5VesaB21G23RdXWshx";

export const defaultAvatar = "/img/avatar.png";

export const solana_api_key =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJjcmVhdGVkQXQiOjE3MzQ5NjY4NzIwMzUsImVtYWlsIjoiemVyb2NobHdvcmtAZ21haWwuY29tIiwiYWN0aW9uIjoidG9rZW4tYXBpIiwiYXBpVmVyc2lvbiI6InYyIiwiaWF0IjoxNzM0OTY2ODcyfQ.IHW9Ohb7kpn0hUDwlBKlN7C-qREogjwr_VxQvP9pJQw";
