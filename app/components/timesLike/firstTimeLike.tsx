    ...
    <div className={styles.main + " " + styles.firstTimeLike}>
      <div className={styles.content}>
        <div className={styles.text}>
          ...
          and mining <strong>10 MEMETICS</strong>
        </div>
      </div>
      ...
      <div className={styles.actionBox}>
        ...
        <div
          className={`${styles.shareBox} button`}
          onClick={() => {
            onShare(data);
          }}
        >
            ...
            <defs>
              ...
              >
                ...
                <feComposite
                  in2="SourceAlpha"
                  operator="in"
                  result="effect1_backgroundBlur_6578_12140"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_backgroundBlur_6578_12140"
                  result="shape"
                />
              </filter>
              <filter
                id="filter1_b_6578_12140"
                x="-4"
                y="-4"
                width="67"
                height="67"
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_6578_12140"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_6578_12140"
                  result="shape"
                />
              </filter>
            </defs>
