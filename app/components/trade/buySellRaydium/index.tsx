      ...
      if (debounceVal) {
        ...
        if (activeIndex === 0) {
          ...
          if (tokenType === 1) {
            ...
            getQoute(
              new Big(debounceVal).mul(10 ** SOL.tokenDecimals).toString(),
              "buy",
              slip / 100
            )
              .then((res) => {
                ...
                setBuyIn(new Big(res as string).toFixed(token.tokenDecimals));
            ...
            getQoute(
              ...
              .then((res) => {
                ...
                setBuyInSol(
                  new Big(res as string).div(10 ** SOL.tokenDecimals).toString()
                );
              ...
              <MainBtn
                ...
                onClick={async () => {
                  try {
                    ...
                    if (activeIndex === 0) {
                      setIsLoading(true);
                      hash = await trade(new Big(buyInSol).mul(10 ** SOL.tokenDecimals).toString(), 'buy', slip);
                      if (hash) {
                      ...
                      hash = await trade(new Big(sellOut).toString(), 'sell', slip);
                    }
                    setIsLoading(false);
